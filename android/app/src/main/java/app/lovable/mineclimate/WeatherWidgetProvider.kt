    ...
    companion object {
        ...
        private suspend fun fetchAndUpdateWidget(
            ...
            try {
                ...
                if (imageUrl != null) {
                    try {
                        ...
                        if (result is SuccessResult) {
                            ...
                            android.util.Log.e("WeatherWidget", "Image load failed: $result")
                        }
                    } catch (e: Exception) {
                        android.util.Log.e("WeatherWidget", "Image exception", e)
                    }
                }
                ...
                android.util.Log.e("WeatherWidget", "fetchAndUpdateWidget failed", e)
            }
        }
